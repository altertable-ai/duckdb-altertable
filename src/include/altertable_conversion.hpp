...
#define ALTERTABLE_EPOCH_JDATE 2451545 /* == date2j(2000, 1, 1) */
#define DUCKDB_EPOCH_DATE      2440588
#define ALTERTABLE_MIN_DATE    -2440589
#define ALTERTABLE_MAX_DATE    2145042906
#define ALTERTABLE_DATE_INF    2147483647U
#define ALTERTABLE_DATE_NINF   2147483648U
#define ALTERTABLE_EPOCH_TS    211813488000000000ULL
#define DUCKDB_EPOCH_TS        210866803200000000ULL
#define ALTERTABLE_INFINITY    9223372036854775807ULL
#define ALTERTABLE_NINFINITY   9223372036854775808ULL
...
struct AltertableDecimalConfig {
	uint16_t scale;
	uint16_t ndigits;
	int16_t weight;
	bool is_negative;
...
struct DecimalConversionInteger {
	...
	template <class T>
	static T Finalize(const AltertableDecimalConfig &config, T result) {
		return result;
	}
};
...
struct DecimalConversionHugeint {
	...
	static hugeint_t Finalize(const AltertableDecimalConfig &config, hugeint_t result) {
		return result;
	}
};
...
struct DecimalConversionDouble {
	...
	static double Finalize(const AltertableDecimalConfig &config, double result) {
